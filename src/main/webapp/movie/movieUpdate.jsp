			...
			<tr>
				...
				<td>
					<table>
						...
						<tr>
							<th>시놉시스</th>
							<td><textarea cols="90" rows="10" name="synopsis" value="${movie.synopsis}"></textarea></td>
						</tr>
					</table>
				</td>
			</tr>
		</table><br>
		<input type="submit" value="수정"><input type="button" value="목록" onclick="location.href='movielist.do'">
	</form>
</div>
</body>
</html>